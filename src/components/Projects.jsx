  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive multi-tenant SaaS platform featuring AI-driven insights, real-time notifications, role-based access control, and subscription management via Stripe.",
      tech: ["Next.js 14", "NestJS", "TypeScript", "Socket.io", "Tailwind CSS"],
      liveUrl: "https://ziadeldesoky.dev",
      githubUrl: "https://github.com/ZiadEldesoky/AI-Powered-Saas-Dashboard",
    ...
    },
    {
      ...
      description:
        "Full-featured e-commerce platform with JWT auth, Quick View, Related Products, Recently Viewed, Coupons, PWA support, and Admin Dashboard.",
    ...
    },
    {
      title: "AgriLink MVP",
      description:
        "A platform connecting farmers directly with consumers, featuring real-time inventory, order management, and secure payments.",
    ...
    },
    {
      ...
      description:
        "A full CRUD task management app with authentication, priority levels, and dynamic filtering. Built with React Hooks and Express APIs.",
    ...
    },
    {
      ...
      description:
        "A fully responsive, animated personal portfolio built with React and Tailwind CSS, showcasing clean UI and fast performance.",
    ...
    },
    {
      ...
      description:
        "My first e-commerce project built with pure JavaScript, HTML, CSS, and SCSS. Features product catalog, shopping cart, and responsive design.",
    ...
    >
      <div className="w-full max-w-6xl mx-auto">
        ...
        >
          ...
          <p
            className="text-[var(--text-secondary)] mt-8 max-w-2xl mx-auto text-lg"
        ...
        {/* View More */}
        <div
          className={`text-center mt-16 transition-all duration-700 delay-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <a
